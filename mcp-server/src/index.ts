...
server.tool(
  'search_symbol',
  'Search for functions, classes, interfaces, types by name. Returns file locations and line numbers.',
  {
...
server.tool(
  'get_code',
  'Get specific line range from a source file. Use this to read only the code you need.',
  {
...
server.tool(
  'find_callers',
  'Find all places where a symbol (function/class/variable) is used across the project.',
  {
...
server.tool(
  'grep',
  'Full-text search across all project files using regex pattern.',
  {
...
server.tool(
  'get_file',
  'Get the entire content of a source file with line numbers.',
  {
...
server.tool(
  'project_summary',
  'Get a high-level overview of the entire Rei project: files, symbols, dependencies.',
  {},
  async () => {
